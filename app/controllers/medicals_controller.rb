class MedicalsController < ApplicationController
  ...
  private
    ...
    def medical_params
      params.require(:medical).permit(:name, :str_application_period, :end_application_period, :str_implementation_period, :end_implementation_period, :remarks, :deleteflg)
    end
end
